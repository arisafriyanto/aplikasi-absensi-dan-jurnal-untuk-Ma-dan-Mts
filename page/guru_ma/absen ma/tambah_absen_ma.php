...
if (isset($_POST['tambah'])) {
    ...
    if ($total_jam > 8) {
        echo '
                <script type="text/javascript">
                    ...
                    window.location.href = "?page=absen_ma&aksi=tambah";
                </script>
                ';
        return false;
    }
    ...
    $sql = mysqli_query($conn, "INSERT INTO absen_ma (tanggal, id, nama, jabatan, tunjab,  total_jam, jam_1, jam_2, jam_3, jam_4, jam_5, jam_6, jam_7, jam_8, guru_ma) VALUES ('$tanggal', '$id',  '$nama', '$jabatan', '$tunjab', '$total_jam', '$jam_1', '$jam_2', '$jam_3', '$jam_4', '$jam_5', '$jam_6', '$jam_7', '$jam_8', '$guru_ma')");
