...
if (!isset($_GET['id_absen'])) {
    header("location: ?page=absen_ma");
}

$id_absen = $_GET['id_absen'];

$sql = mysqli_query($conn, "select * from absen_ma where id_absen= " . $id_absen);
...
if (isset($_POST['edit'])) {
    ...
    if ($total_jam > 8) {
        echo '
                <script type="text/javascript">
                    ...
                    window.location.href = "?page=absen_ma&aksi=edit&id_absen=' . $id_absen . '";
                </script>
                ';
        return false;
    }
    ...
    $sql = mysqli_query($conn, "UPDATE absen_ma SET nama='$nama', total_jam='$total_jam', jam_1='$jam_1', jam_2='$jam_2', jam_3='$jam_3', jam_4='$jam_4', jam_5='$jam_5', jam_6='$jam_6', jam_7='$jam_7', jam_8='$jam_8' WHERE id_absen= " . $id_absen);

    if ($sql) {
?>
        <script type="text/javascript">
            alert("Data Absen Berhasil Diedit...!!!");
            window.location.href = "?page=absen_ma";
        </script>
<?php
    }
}
