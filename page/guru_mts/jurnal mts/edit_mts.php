...
if (!isset($_GET['id_jurnal'])) {
    header("location: ?page=jurnal_mts");
}

$id_jurnal = $_GET['id_jurnal'];

$sql = mysqli_query($conn, "select * from jurnal_mts where id_jurnal= " . $id_jurnal);
            ...
            <form action="" method="post">
                ...
                <div class="row form-group">
                    ...
                    <div class="col col-md-12">
                        ...
                        <input type="text" placeholder="pokok bahasan" name="materi_7" class="form-control" id="materi_7" value="<?= $data['materi_7'] ?>">
                    </div>
                </div>
                ...
                <div class="row form-group">
                    ...
                    <div class="col col-md-12">
                        ...
                        <input type="text" placeholder="pokok bahasan" name="materi_8" class="form-control" id="materi_8" value="<?= $data['materi_8'] ?>">
                    </div>
                </div>
                ...
                <div class="row form-group">
                    <div class="col col-md-12">
                        ...
                        <input type="text" placeholder="pokok bahasan" name="materi_9" class="form-control" id="materi_9" value="<?= $data['materi_9'] ?>">
                    </div>
                </div>
...
if (isset($_POST['edit'])) {
    ...
    $sql = mysqli_query($conn, "UPDATE jurnal_mts SET nama='$nama', mapel='$mapel', jam_1='$jam_1', jam_2='$jam_2', jam_3='$jam_3', jam_4='$jam_4', jam_5='$jam_5', jam_6='$jam_6', jam_7='$jam_7', jam_8='$jam_8', status='$status', materi_7='$materi_7', materi_8='$materi_8', materi_9='$materi_9' WHERE id_jurnal= " . $id_jurnal);
