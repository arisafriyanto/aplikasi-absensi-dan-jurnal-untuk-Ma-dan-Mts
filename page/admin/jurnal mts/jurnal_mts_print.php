...
<div class="card col-md-12">
    <h3 class="title-3 m-b-30 ml-3 mt-4 mb-4">
        <i class="fas fa-print"></i>Print Jurnal Mts
    </h3>
    ...
    <div class="card">
        ...
        <div class="card-body card-block">
            <form action="../../report/cetak_jurnal_mts.php" method="post" enctype="multipart/form-data" target="_blank">
        ...
        <div class="card-footer">
            ...
            <input type="submit" class="btn btn-success btn-sm" name="print_mts_jurnal" value="Print Jurnal">
