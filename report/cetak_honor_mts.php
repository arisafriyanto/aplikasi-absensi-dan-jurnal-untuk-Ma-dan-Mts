...
if (isset($_POST['print_mts_honor']) != "") {
    // SELECT  id_pelanggan,
    ...
    $tampil = mysqli_query($conn, "select id, nama, jabatan, tunjab, total_jam, sum(if(month(tanggal) = " . $tgl_sql . ", total_jam, 0)) as total_jam_s from absen_mts where tanggal between '$tgl_awal' and '$tgl_akhir' group by id ");
}
...
$content .= "
            ...
            <div style='padding: 20px 0 10px 0; text-align: center; font-size:18px;'>
                ...
                <P>
                    NAMA MADRASAH : MTS SA BANI MA'MUN ASSALAMI<br>
                    KECAMATAN     : KIBIN</P>
