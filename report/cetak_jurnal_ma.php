...
if (isset($_POST['print_ma_jurnal']) != "") {
    $tampil = mysqli_query($conn, "select * from jurnal_ma where tanggal between '$tgl_awal' and '$tgl_akhir' order by tanggal asc");
}
...
$content .= "
            ...
            <div style='padding: 20px 0 10px 0; text-align: center; font-size:18px; '>
                DAFTAR JURNAL MA BANI MA'MUN ASSALAMI KIBIN<br>
                ...
                <table border='1px' cellpadding='0' cellspacing='0' class='table'>
                    <tr>
                        ...
                        <th>Kelas 10 : Materi</th>
                        <th>Kelas 11 : Materi</th>
                        <th>Kelas 12 : Materi</th>
                    </tr>";
...
while ($data = mysqli_fetch_assoc($tampil)) {
    ...
    $content .= '
                                        <tr>
                                            ...
                                            <td>' . $data['status'] . '</td>
                                            <td width="180">' . $data['materi_10'] . '</td>
                                            <td width="180">' . $data['materi_11'] . '</td>
                                            <td width="180">' . $data['materi_12'] . '</td>
                                        </tr>
                                    ';
}
